...
import dev.skyherobrine.app.controllers.OneTimePadController;
import dev.skyherobrine.app.controllers.VigenereCipherController;

import javax.swing.*;
import javax.swing.event.ChangeEvent;
import javax.swing.event.ChangeListener;

public class OneTimePadPanel extends JPanel {
    ...
    public OneTimePadPanel() {
        ...
        btnProcess.addActionListener(new OneTimePadController(this));
        add(btnProcess);
    }

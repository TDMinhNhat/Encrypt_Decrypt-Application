...
import dev.skyherobrine.app.controllers.RailFenceCipherController;
import javax.swing.*;
import javax.swing.event.ChangeEvent;
import javax.swing.event.ChangeListener;

public class RailFenceCipherPanel extends JPanel {
    ...
    public RailFenceCipherPanel() {
        ...
        btnProcess.addActionListener(new RailFenceCipherController(this));
        add(btnProcess);
    }
